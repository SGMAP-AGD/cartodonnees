---
title: "Cartographie Collaborative des données de l'État"
...
* `r length(gestionnaires) - length(diff)` gestionnaires sont identifiés dans l'annuaire des services publics. `r length(diff)` ne sont pas identifiés. Il s'agit d'associations ou  d'entreprises privées.
