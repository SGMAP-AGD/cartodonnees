...
intersectproducteursgestionnaires <- intersect(producteurs, administrations)
...
`r length(producteurs)` producteurs de données publient actuellement `r length(datasets)` datasets sur [data.gouv.fr](https://www.data.gouv.fr). `r length(intersectproducteursgestionnaires)` producteurs sont présents dans l'annuaire des administrations, soit `r round(length(intersectproducteursgestionnaires) * 100/ length(producteurs),2)`%.
